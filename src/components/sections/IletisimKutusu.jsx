          ...
          <div className="relative z-10 p-8 md:p-12 lg:p-16">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                {/* Adres */}
                <div className="flex items-start gap-5 bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20">
                  ...
                  <div className="text-white">
                    <p className="text-sm text-gray-300 mb-1">Ofis Adresimiz</p>
