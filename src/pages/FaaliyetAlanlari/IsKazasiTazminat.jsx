...
import { isKazasiGiris, isKazasiBolumler } from '../../data/tazminatHukukuIcerik';

export default function IsKazasiTazminat() {
  const breadcrumbItems = [
    { name: 'Ana Sayfa', url: '/' },
    { name: 'Faaliyet Alanları', url: '/faaliyet-alanlari' },
    { name: 'Tazminat Hukuku', url: '/faaliyet-alanlari/tazminat-hukuku' },
    { name: 'İş Kazası Tazminatı', url: '/faaliyet-alanlari/tazminat-hukuku/is-kazasi-tazminat' }
  ];

  return (
    <>
      <SEOHead
        title="İş Kazası Tazminat Davaları"
        description="İş kazası veya meslek hastalığı nedeniyle zarar gören işçi ya da yakınlarının işverene karşı maddi ve manevi tazminat talepleri hakkında bilgilendirici içerik."
        canonical="/faaliyet-alanlari/tazminat-hukuku/is-kazasi-tazminat"
        ogType="article"
      />
      <ArticleSchema
        baslik="İş Kazasından Kaynaklı Tazminat"
        aciklama="İş kazası veya meslek hastalığı nedeniyle zarar gören işçi ya da yakınlarının işverene karşı maddi ve manevi tazminat talepleri hakkında bilgilendirici içerik."
      ...
      <section className="relative bg-gradient-to-br from-primary-500 to-primary-700 text-white py-16 md:py-24 overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">İş Kazasından Kaynaklı Tazminat</h1>
            <p className="text-xl text-gray-200">
              İş kazası ve meslek hastalığından doğan maddi ve manevi tazminat talepleri
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
                <div className="flex-grow text-center md:text-left">
                  <h3 className="text-2xl font-serif font-bold mb-2">
                    İş Kazası Tazminatı Hakkında Sorularınız mı Var?
                  </h3>
