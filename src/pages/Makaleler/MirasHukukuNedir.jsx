...
export default function MirasHukukuNedir() {
  const breadcrumbItems = [
    { name: 'Ana Sayfa', url: '/' },
    { name: 'Makaleler', url: '/makaleler' },
    { name: 'Miras Hukuku Nedir?', url: '/makaleler/miras-hukuku-nedir' }
  ];
  ...
  return (
    <>
      <SEOHead
        ...
        description="Miras hukuku nedir? Miras paylaşımı, veraset, vasiyetname, tenkis davası ve mirasın reddi hakkında bilgilendirici makale."
        canonical="/makaleler/miras-hukuku-nedir"
        ogType="article"
      />
      <ArticleSchema
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <header className="mb-12">
              ...
              <h1 className="section-title">Miras Hukuku Nedir?</h1>
            </header>
            ...
            <div className="prose prose-lg max-w-none">
              ...
              {mirasHukukuSSS.length > 0 && (
                <section className="mb-8">
                  <h2 className="text-xl font-serif font-bold text-primary-500 mb-4">
                    Sık Sorulan Sorular
                  </h2>
                  {mirasHukukuSSS.map((item) => (
