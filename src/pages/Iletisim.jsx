...
export default function Iletisim() {
  ...
  return (
    <>
      <SEOHead
        title="İletişim"
        description={`${avukatBilgileri.tamAd} iletişim bilgileri. Telefon: ${avukatBilgileri.telefonGosterim}. Adres: ${avukatBilgileri.adres.tam}`}
        canonical="/iletisim"
      />
      <LocalBusinessSchema />
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center">
                ...
                <h3 className="text-lg font-serif font-bold text-primary-500 mb-2">Konum</h3>
                <p className="text-gray-600 font-medium">{avukatBilgileri.adres.ilce}/{avukatBilgileri.adres.il}</p>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-primary-500 text-lg">{avukatBilgileri.adres.tam}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-r from-accent-500 to-accent-600 rounded-2xl p-8 text-white text-center">
                  ...
                  <a
                    href={avukatBilgileri.telefonLink}
                    className="inline-flex items-center gap-3 bg-white text-accent-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition-colors"
                  >
            ...
            <div className="mt-12 bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="p-6 border-b border-gray-100">
                <h3 className="text-xl font-serif font-bold text-primary-500 flex items-center gap-2">
              ...
              <div className="h-80">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d48268.90982652778!2d29.396741199999997!3d40.802467!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cac7a3bfcfc8e5%3A0x7b5b3c2e5c9b0bea!2sGebze%2C%20Kocaeli!5e0!3m2!1str!2str!4v1706540000000!5m2!1str!2str"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen=""
                  ...
                  title="Ofis Konumu - Gebze/Kocaeli"
                ></iframe>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700">
                    Randevu almak için lütfen telefon ile iletişime geçiniz.
                    Hukuki süreçlerinizle ilgili sorularınızı görüşme sırasında detaylı olarak iletebilirsiniz.
                  </p>
                </div>
              </div>
